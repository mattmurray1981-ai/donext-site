...
test('tracked site files satisfy the deploy-time public contract', () => {
  ...
  for (const route of new Set([
    ...
    '/data/bristol-today.json',
    '/base.css',
    '/style.css',
    '/cardiff-catalog.js',
    '/app.js',
    '/thank-you.html',
    '/bristol/thank-you/index.html',
    '/_redirects',
    ...
    '/assets/brand/bristol/donext-bristol-share-v4.png',
  ])) {
...
test('release route checks cover both city pages, forms, private paths and functions', () => {
