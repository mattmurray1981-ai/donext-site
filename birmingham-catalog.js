/**
 * DoNext Birmingham catalog — loads data/birmingham-today.json and renders
...
(function (global) {
  ...
  var DATA_URL = '/data/birmingham-today.json';
  ...
  function showError(msg) {
    ...
    if (banner) {
      banner.hidden = false;
      banner.innerHTML = '<strong>Could not load the Birmingham catalog.</strong> ' + escapeHtml(msg);
    }
  }
